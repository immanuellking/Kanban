export default function ColumnTask({ task }: { task: Task }) {
  ...
  return (
    <div className="group bg-[#2B2C37] h-24 flex flex-col justify-center px-4 rounded-sm space-y-2 cursor-pointer shadow-[0px_4px_6px_0px_rgba(54,78,126,0.10)]">
